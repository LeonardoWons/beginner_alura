from criando_exception import SaldoInsuficienteError, OperacaoFinanceiraError
...
#try:
    ...
    leitor = LeitorDeArquivo("texto.txt")
    leitor.ler_prox_linha()
    leitor.ler_prox_linha()
#except IOError:
    leitor.ler_prox_linha()
#except FileNotFoundError:
    print("IOerror capturada")
#finally:
    print("Documento nao encontrado")
    if "leitor" in locals():
        leitor.fechar()   

with LeitorDeArquivo("texto.txt") as leitor:
    leitor.ler_prox_linha()